...
from blockchain_backend.utils.crypto_hash import *
from blockchain_backend.utils.hex_to_binary import *
...
class Block:
    ...
    def adjust_difficulty(last_block, new_timestamp):
        ...
        """
        if (new_timestamp - last_block.timestamp) < MINE_RATE * 60:
    ...
    def is_valid_block(last_block, block):
        ...
        # FIX: use same order as mine_block
...
def script_backend_single_run(data1):
    # Request Object here
